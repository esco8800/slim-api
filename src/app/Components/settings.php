...
// or
define('C_REST_WEB_HOOK_URL','https://mfc-city.bitrix24.ru/rest/1/fbrq4n7o3xgnrktn/');//url on creat Webhook
...
define('C_REST_LOGS_DIR', __DIR__ .'/../../storage/bitrixLogs/'); //directory path to save the log